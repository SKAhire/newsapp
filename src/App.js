  ...
  render() {
    return (
      <>
        ...
        <Navbar />
        <Routes>
		          <Route exact path="/" element={<News pageSize={8} key="" country="in" />} />
		          <Route exact path="/general" element={<News pageSize={8} key="general" country="in" category="general"/>} />
		          <Route exact path="/business" element={<News pageSize={8} key="business" country="in" category="business"/>} />
		          <Route exact path="/entertainment" element={<News pageSize={8} key="entertainment" country="in" category="entertainment"/>} />
